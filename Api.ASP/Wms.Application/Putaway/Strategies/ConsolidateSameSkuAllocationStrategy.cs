...
/// <summary>
/// Ranks locations that already hold the same product (and same lot when one is
/// supplied). Finite-capacity locations come first and, within those, the one with
...
/// </summary>
internal sealed class ConsolidateSameSkuAllocationStrategy : IPutawayAllocationStrategy
{
    public PutawayStrategyType Type => PutawayStrategyType.ConsolidateSameSku;

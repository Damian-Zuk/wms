...
.EXAMPLE
  ./deploy/setup-azure.ps1 -PgAdminPassword 'S0me-Strong-Pwd' -AdminAccountPassword 'Admin1234!'
#>
...
param(
    ...
    [string]$SwaOrigin = "https://ambitious-wave-066504303.7.azurestaticapps.net"
)
